...
define('chart',[
  ...
  _.defaults(Chart.prototype, {
    ...
    _draw: function () {
      ...
      self._noData = _.flatten(_.pluck(self._mainData, 'data')).length === 0;
      if (!o.noDataMainOnly) {
        _.each(self._compData, function (compData) {
          var compNoData = _.flatten(_.pluck(compData, 'data')).length === 0;
          self._noData = self._noData && compNoData;
        });
      }
